...
p "Kurt Bremser, 2019"/style=[font_weight=bold] ;
p "https://support.sas.com/resources/papers/proceedings19/3062-2019.pdf";
p "";
p " SAS Communities Library  Maxims of Maximally Efficient SAS Programmers"/style=[font_weight=bold] ;
p "https://communities.sas.com/t5/SAS-Communities-Library/Maxims-of-Maximally-Efficient-SAS-Programmers/ta-p/352068";

p "";
p "Maxim 1: Read the Documentation." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 2: Read the Log." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 3: Know Your Data." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 4: If in Doubt, Do a Test Run and Look at the Results. If Puzzled, Inquire Further." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 5: Ask, and You Will Be Answered." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 6: Google Is Your Friend." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 7: There Is a Procedure for It." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 8: There Is a Format for It." / style=[font_weight=bold font_size=12pt];
p "(The exception proves the rule)";
...
p "";
p "Maxim 9: There Is a Function for It." / style=[font_weight=bold font_size=12pt];
p "(The exception proves the rule)";
...
p "";
p "Maxim 10: SQL May Eat Your WORK and Your Time." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 11: A Macro Is Not Needed." / style=[font_weight=bold font_size=12pt];
p "(The exception proves the rule)";
...
p "";
p "Maxim 12: Make It Look Nice." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 13: When You're Through Learning, You're Through." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 14: Use the Right Tool." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 15: Know Your Playing Field." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 16: If It Isn't Written, It Is Not." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 17: Do It the SAS Way." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 18: Separate Your Names." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 19: Long Beats Wide." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 20: Keep Your Names Short." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 21: Formats Beat Joins." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 22: Force Correct Data." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 23: Recursion." / style=[font_weight=bold font_size=12pt];
p "Recursion.See Maxim 23.";
p "";
p "Maxim 24: Return With a Zero." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 25: Have a Clean Log." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 26: .sas Trumps Catalogs." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 27: Textuality Rules." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 28: Macro Variables Need No Formats." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 29: When In Doubt, Use Brute Force." / style=[font_weight=bold font_size=12pt];
p "(Ken Thompson)";
...
p "";
p "Maxim 30: Analyze, Then Optimize." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 31: Computers Are Dumb." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 32: No Test Without COMPARE." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 33: Intelligent Data Makes for Intelligent Programs." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 34: Work in Steps." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 35: There's Two Kinds of Stupidity." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 36: No Work Is Done Until the Final Test Has Run." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 37: Perfection." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 38: Beware of the Dread God Finagle." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 39: Be Human." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 40: Talk to the Customer." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 41: Wisdom Emerges from Experience." / style=[font_weight=bold font_size=12pt];
p "Unfortunately, most experience emerges from stupidity.";
p "";
p "Maxim 42: It's Not the Answer, It's the Question." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 43: Keep the Final Goal in Mind." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 44: Leave No Spaces." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 45: TANSTAAFL." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 46: Beware of the Hidden Blanks." / style=[font_weight=bold font_size=12pt];
...
p "Example:";
p "if charvar in ('AAA','BBB','CCC');" / style=[color=blue];
p "will work even if the defined length of charvar is > 3, but";
p "if findw('AAA BBB CCC',charvar) > 0;"/ style=[color=blue];
...
p "";
p "Maxim 47: Set a Length." / style=[font_weight=bold font_size=12pt];
...
p "Example:";
p "flag = 'no';"/ style=[color=blue];
p "if (condition) then flag = 'yes';"/ style=[color=blue];
p "if flag = 'yes' then ..."/ style=[color=blue];
p "Surprise!";
p "";
p "Maxim 48: The Dot, the Dot, Always the Dot." / style=[font_weight=bold font_size=12pt];
...
p "See";
p 'libname myexcel xlsx "/path/excelfile&year.xlsx";';
p "";
p "Maxim 49: Don't Forget to run;" / style=[font_weight=bold font_size=12pt];
...
p "data _null_;"/ style=[color=blue];
p "call symputx('nobs',nobs);"/ style=[color=blue];
p "set have nobs=nobs;"/ style=[color=blue];
p '%do i = 1 %to &nobs;'/ style=[color=blue];
...
p "";
p "Maxim 50: Check Your OBS= System Option." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 51: Hash Can Fire You Up." / style=[font_weight=bold font_size=12pt];
...
p "";
p "Maxim 52: Take a Break." / style=[font_weight=bold font_size=12pt];
